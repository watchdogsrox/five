...
// Started	:	2/5/11
//
#ifndef _VOLUME_BOX_H_
#define _VOLUME_BOX_H_
...
class CVolumeBox : public CVolumePrimitiveBase 
{
public:
    FW_REGISTER_CLASS_POOL(CVolumeBox);
	DECLARE_RTTI_DERIVED_CLASS(CVolumeBox, CVolumePrimitiveBase);
public:
