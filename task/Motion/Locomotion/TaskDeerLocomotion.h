#ifndef TASK_DEER_LOCOMOTION_H
#define TASK_DEER_LOCOMOTION_H

#include "Task/Motion/TaskMotionBase.h"

//*********************************************************************
//	CTaskDeerLocomotion
//	The top-level motion task for the on-foot moveblender for a Deer. 
//*********************************************************************

class CTaskDeerLocomotion
	: public CTaskMotionBase
{
public:
	CTaskDeerLocomotion( u16 initialState, u16 initialSubState, u32 blendType, const fwMvClipSetId &clipSetId);
	virtual ~CTaskDeerLocomotion();
	...
	virtual aiTask*	Copy() const { return rage_new CTaskDeerLocomotion(m_initialState, m_initialSubState, m_blendType, m_clipSetId); }
	virtual s32		GetTaskTypeInternal() const { return CTaskTypes::TASK_ON_FOOT_DEER; }
