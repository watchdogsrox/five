ENUM DECISION_MAKER_TYPE
    DECISION_MAKER_DEFAULT = -455129387,
    DECISION_MAKER_EMPTY = -1143637011,
    DECISION_MAKER_PLAYER = 1862763509,
    DECISION_MAKER_COP = -1533126372,
  
    DECISION_MAKER_INVALID = 0
ENDENUM

ENUM EVENT_RESPONSE_TASK
    RESPONSE_TASK_COMBAT = -729742343,
    RESPONSE_TASK_CROUCH = 1154773195,
    RESPONSE_TASK_FLEE = -243782059,
    RESPONSE_TASK_TURN_TO_FACE = 793130409,
    RESPONSE_TASK_COWER = 1532653469,
    RESPONSE_TASK_HANDS_UP = -1622232402,
    RESPONSE_TASK_GUN_AIMED_AT = 560142258,
    RESPONSE_TASK_LEAVE_CAR_AND_FLEE = -1048758309,
    RESPONSE_TASK_WALK_ROUND_FIRE = 2045503730,
    RESPONSE_TASK_WANTED = 883297727,
    RESPONSE_TASK_INVALID = 0
ENDENUM
...
ENUM SHOCKING_EVENT_LEVEL
	SHOCKING_EVENT_INTERESTING,
	SHOCKING_EVENT_AFFECTS_OTHERS,
	SHOCKING_EVENT_POTENTIALLY_DANGEROUS,
	SHOCKING_EVENT_DANGEROUS,
	SHOCKING_EVENT_SERIOUS_DANGER
ENDENUM
