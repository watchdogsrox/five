#ifndef AUD_WARP_MANAGER_H_
#define AUD_WARP_MANAGER_H_
...
public:
	...
	static void	Update();
	static bool	SetWarp(const Vector3 &pos, const Vector3 &vel, float fHeadingInRadians, bool teleportVehicle, bool bSnapToGround, float fRadius = -1.0f);
	...
	static void SetScriptThreadId(scrThreadId scriptThreadId) { m_bOwnedByScript = true; m_scriptThreadId=scriptThreadId; }
