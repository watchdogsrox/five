...
#endif
#ifndef FXAA_HLSL_3
	#define FXAA_HLSL_3 ((__SHADERMODEL < 40) ? 1 : 0)
#endif
#ifndef FXAA_HLSL_4
    #define FXAA_HLSL_4 ((__SHADERMODEL < 40) ? 0 : 1)
#endif    
/*--------------------------------------------------------------------------*/
#if FXAA_GLSL         
    #define int2 ivec2
	...
	#define SetFxaaTex(tex, sampleC) FxaaTex sampleC
#endif
/*--------------------------------------------------------------------------*/
#if FXAA_HLSL_3
	#define uint int
...
*/
//
//struct FXAAVertexInput {
//	float3 pos	: POSITION;
//	float2 tex	: TEXCOORD0;
//};
//
//struct FXAAVertexOutputPassThrough {
//	float4 pos	: POSITION;
//	float2 tex	: TEXCOORD0;
//};
//
//struct FXAAPixelInput {
//	float2 tex	: TEXCOORD0;
//};

//FXAAVertexOutputPassThrough VS_Passthrough(FXAAVertexInput IN)
//{
//	FXAAVertexOutputPassThrough OUT = (FXAAVertexOutputPassThrough)0;
